...
import os
import pickle
from data_loader import load_dataset_crossentropy
from data_loader import load_test_dataset_crossentropy
...
def main(args):
	...
	#Define optimizer to set different learning rates for encoder and mlp
